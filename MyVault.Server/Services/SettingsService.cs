...
namespace MyVault.Server.Services
{
    ...
    public class SettingsService : ISettingsService
    {
        ...
        /// mail settings property (lazy)
        /// </summary>
        private readonly Lazy<NotificationSettings> _notifSettings;
        /// <summary>
        /// mail settzings property
        /// </summary>
        /// <value></value>
        public NotificationSettings Notif { get { return _notifSettings.Value; } }
        /// <summary>
        /// dbcontext property
        /// </summary>
        ...
        public SettingsService(AppDbContext unitOfWork)
        {
            ...
            _notifSettings = new Lazy<NotificationSettings>(CreateSettings<NotificationSettings>);
        }
        ...
        public async Task Save()
        {
            ...
            if (_notifSettings.IsValueCreated)
                await _notifSettings.Value.Save(_unitOfWork);
